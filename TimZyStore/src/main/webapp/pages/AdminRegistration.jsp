...
<body>
    <div class="container">
        ...
        <div class="form-container">
            ...
            <form action="${pageContext.request.contextPath}/AdminUserRegistrationServlet" method="POST"enctype='multipart/form-data'>
                ...
                <input type="hidden" id="account_category" name="account_category" value="Admin">
